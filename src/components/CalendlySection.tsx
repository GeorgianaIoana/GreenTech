      ...
      <section id="schedule" className="py-12 md:py-20">
        <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-700 leading-relaxed max-w-2xl mx-auto font-outfit">
              Let's discuss your project. Choose a convenient time for a 30-minute conversation.
            </p>
          </div>
