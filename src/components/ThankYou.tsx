...
const ThankYou: React.FC = () => {
  ...
  const translations = {
    en: {
      ...
      responseTime: "Average response time: under 24h on business days.",
      whileWaiting: "While you wait, you can:",
      exploreProjects: "Explore our projects",
      seeServices: "See the services we offer",
      contactWhatsApp: "Contact us directly on WhatsApp",
      backHome: "Back to Home",
      seeProjects: "See Projects",
      urgentResponse: "Need an urgent response?",
      writeWhatsApp: "Write on WhatsApp",
    },
    ro: {
      title: "Mulțumim pentru mesaj!",
      message: "Am primit mesajul tău și îți vom răspunde în cel mai scurt timp posibil.",
      responseTime: "Timp mediu de răspuns: sub 24 de ore în zilele lucrătoare.",
      whileWaiting: "În timp ce aștepți, poți să:",
      exploreProjects: "Explorezi proiectele noastre",
      seeServices: "Vezi serviciile pe care le oferim",
      contactWhatsApp: "Ne contactezi direct pe WhatsApp",
      backHome: "Înapoi la Acasă",
      seeProjects: "Vezi Proiectele",
      urgentResponse: "Ai nevoie de un răspuns urgent?",
      writeWhatsApp: "Scrie pe WhatsApp",
    },
  };
