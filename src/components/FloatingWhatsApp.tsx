...
const FloatingWhatsApp: React.FC<FloatingWhatsAppProps> = ({
  ...
  return (
    <a
      ...
      rel="noreferrer"
      aria-label="WhatsApp"
      className="fixed bottom-3 left-20 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full bg-green-500 text-white shadow-xl ring-1 ring-black/5 transition hover:scale-105 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-300"
    >
      <svg
        viewBox="0 0 32 32"
        fill="currentColor"
